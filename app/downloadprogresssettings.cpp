...
const char Key[] = "ShowDownloadProgress";
...
DownloadProgressSettings::DownloadProgressSettings(QObject *parent)
    : QObject(parent)
{
...
void DownloadProgressSettings::setEnabled(bool enabled)
{
